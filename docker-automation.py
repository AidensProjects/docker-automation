...
View Volumes
    """)
    maininput = input("-> ").casefold()
    if maininput == 'create container':
        create_container()
    elif maininput == 'delete container':
        delete_container()
    elif maininput == 'rename container':
        rename_container()
    elif maininput == 'view container':
        view_all_containers()
    elif maininput == 'build image':
       build_image()
    elif maininput == 'rename image':
        rename_image()
    elif maininput == 'view image':
        view_volumes()
